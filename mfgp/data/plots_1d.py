...
if __name__ == "__main__":
    ...
    dim = 1
    X_train_hf, X_train_lf, y_train_lf, f_high, f_low, X_test, y_test, y_train_hf = ex1D.get_curve1(num_hf, num_lf)
    ...
    plot_predictions(nardgp_mean, nardgp_var, X_test, "NARDGP")
    ...
    plot_predictions(dgpdfc_mean, dgpdfc_var, X_test, "DGPDFC")
    ...
    plot_predictions(mean_ar1, var_ar1, X_test, "AR1")  
    plt.legend()
    plt.show()
